...
export default {
  transformations: {
    ...
    effects: {
      ...
      dynamicPolaroid: { title: "Dynamic Polaroid", description: "Turn your group photos into a living memory. First, generate a perfect polaroid shot, then bring it to life as a short, animated video." },
      customPrompt: { 
        title: "Custom Prompt", 
      ...
      styleMimic: { 
        title: "Style Mimic", 
        description: "Applies the artistic style from a reference image to your content image.",
        uploader1Title: "Content Image",
        uploader1Desc: "The image you want to change.",
        uploader2Title: "Style Reference",
        uploader2Desc: "The image providing the style."
      },
      candidShot: { title: "Candid Shot", description: "Recreates your photo as a spontaneous, casual snapshot with imperfect lighting and everyday clutter." },
      papercraft: { title: "Papercraft Model", description: "Turns your subject into a 3D paper model, placed on a cluttered desk." },
      kidsDoodle: { title: "Kid's Doodle", description: "Redraws your image as a child's crayon doodle on messy scratch paper." },
      expressionReference: {
