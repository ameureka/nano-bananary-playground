...
export default {
  transformations: {
    ...
    effects: {
      ...
      dynamicPolaroid: { title: "动态拍立得", description: "将您的合照变成生动的回忆。首先生成一张完美的拍立得照片，然后将其制作成一段生动的短视频。" },
      customPrompt: { 
        title: "自定义提示", 
      ...
      styleMimic: { 
        title: "风格模仿", 
        description: "将参考图像的艺术风格应用于您的内容图像。",
        uploader1Title: "内容图",
        uploader1Desc: "您想要更改的图像。",
        uploader2Title: "风格参考图",
        uploader2Desc: "提供艺术风格的图像。"
      },
      candidShot: { title: "随意拍摄", description: "将您的照片重塑为一张自然的快照，带有不完美的光线和日常杂物。" },
      papercraft: { title: "纸模风格", description: "将您的主题变成一个立体的纸模型，放置在杂乱的桌面上。" },
      kidsDoodle: { title: "小学生涂鸦", description: "将您的图像重绘成儿童在凌乱草稿纸上的蜡笔涂鸦。" },
      expressionReference: {
        title: "表情参考",
